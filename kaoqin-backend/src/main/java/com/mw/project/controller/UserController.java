...
import com.mw.project.model.dto.user.*;
import com.mw.project.model.entity.User;
import com.mw.project.model.vo.UserVO;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        String employeeAccount = userRegisterRequest.getEmployeeAccount();
        String userPassword = userRegisterRequest.getUserPassword();
        String checkPassword = userRegisterRequest.getCheckPassword();
        if (StringUtils.isAnyBlank(userAccount, employeeAccount, userPassword, checkPassword)) {
            return null;
        }
        long result = userService.userRegister(userAccount, employeeAccount, userPassword, checkPassword);
